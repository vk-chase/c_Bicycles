...
RegisterNetEvent('c_Bicycle:client:CruiserMenu')
AddEventHandler('c_Bicycle:client:CruiserMenu', function()
    if IsRenting == true then
        exports['qb-menu']:openMenu({
            ...
            },
            {
                ...
                header = "Pack Cruiser",
                params = {
                    event = "c_Bicycle:client:PackCruiser"
                }
            },
            {
                id = 3,
    ...
    if IsRenting == false then
        exports['qb-menu']:openMenu({
            ...
            },
            {
                ...
                params = {
                    event = "c_Bicycle:client:Cruiser",
                    args = {
                        vehicle = 'cruiser',
...
RegisterNetEvent('c_Bicycle:client:Cruiser')
AddEventHandler('c_Bicycle:client:Cruiser', function(rental)
...
RegisterNetEvent('c_Bicycle:client:PackCruiser')
AddEventHandler('c_Bicycle:client:PackCruiser', function()
    if notifytype == rtx then
