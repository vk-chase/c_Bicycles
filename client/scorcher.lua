...
RegisterNetEvent('c_Bicycle:client:ScorcherMenu')
AddEventHandler('c_Bicycle:client:ScorcherMenu', function()
    if IsRenting == true then
        exports['qb-menu']:openMenu({
            ...
            {
                id = 2,
                header = "Pack Scorcher",
                params = {
                    event = "c_Bicycle:client:PackScorcher"
                }
            },
            {
                id = 3,
    ...
    if IsRenting == false then
        exports['qb-menu']:openMenu({
            ...
            {
                id = 2,
                header = "Place Scorcher",
                params = {
                    event = "c_Bicycle:client:Scorcher",
                    args = {
                        vehicle = 'scorcher',
...
RegisterNetEvent('c_Bicycle:client:Scorcher')
AddEventHandler('c_Bicycle:client:Scorcher', function(rental)
...
RegisterNetEvent('c_Bicycle:client:PackScorcher')
AddEventHandler('c_Bicycle:client:PackScorcher', function()
    if notifytype == rtx then
